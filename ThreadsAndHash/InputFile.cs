    ...
    class InputFile
    {
        ...
        static string GetPath(string _filePath)
        {
            ...
            try
            {
                ...
                {
                    Console.WriteLine("Файл не существует. Укажите иной путь к файлу в виде аргумента в комендной строке и повторите попытку. Нажмите любую клавишу для выхода.");
                    Console.ReadKey();
                    Environment.Exit(0);
                }
                else
        ...
        static long GetPartSizeValue(string _partSize)
        {
            ...
            try
            {
                ...
                {
                    Console.WriteLine("Недостаточно доступной RAM и блок данного размера не сможет быть обработан. Укажите другое значение размера блока в виде аргумента в комендной строке и повторите попытку. Нажмите любую клавишу для выхода.");
                    Console.ReadKey();
                    Environment.Exit(0);
                }
            }
